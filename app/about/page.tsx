...
export default function AboutPage() {
  return (
    <>
      ...
      <Section>
        <div className="mx-auto flex max-w-3xl flex-col items-center gap-6 rounded-sm border border-gold/30 bg-pitch-50 p-8 text-center shadow-sm md:flex-row md:gap-8 md:text-left md:p-10">
